    ...
    while (1) {
        ...
        switch (app_jsonData.state) {
            ...
            case APP_JSON_STATE_PARSING_MESSAGE:
            {
                ...
                jsstringValuesTuples[1] = getValueFromJsonString("sequence_id", jsstring);
                jsstringValuesTuples[2] = getValueFromJsonString("requested_data", jsstring);
                jsstringValuesTuples[3] = getValueFromJsonString("source", jsstring);
                jsstringValuesTuples[4] = getValueFromJsonString("destination", jsstring);
                jsstringValuesTuples[5] = getValueFromJsonString("port", jsstring);
